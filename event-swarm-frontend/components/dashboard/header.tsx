...
export function DashboardHeader() {
  return (
    <header className="flex items-center justify-between px-8 py-4 border-b border-[#1e293b] bg-[#080d12]">
      <div className="flex items-center space-x-12">
        ...
        <nav className="flex items-center space-x-8">
          ...
          <Link href="/assets" className="text-gray-400 hover:text-white text-sm font-medium pb-1 transition-colors">
            Swarm Assets
          </Link>
